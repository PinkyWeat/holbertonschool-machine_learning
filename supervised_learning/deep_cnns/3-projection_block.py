...
def projection_block(A_prev, filters, s=2):
    ...
    conv1_0 = K.layers.Conv2D(F11, 1, strides=s, kernel_initializer=initializer)(A_prev)
    ...
    conv3 = K.layers.Conv2D(F3, 3, padding='same', kernel_initializer=initializer)(relu1_0)
    ...
    shortcut = K.layers.Conv2D(F12, 1, strides=s, kernel_initializer=initializer)(A_prev)
